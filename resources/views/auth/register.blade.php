...
<body class="bg-gray-100 flex items-center justify-center h-screen">
  ...
  <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-sm">
    <h1 class="text-center text-xl font-semibold text-gray-800 mb-6">Form Register</h1>
    ...
    <form action="{{ route('registerProses') }}" method="POST" class="space-y-4">
      ...
      <p class="text-sm text-center mt-4 text-gray-600">
        Sudah punya akun? <a href="{{ route('login') }}" class="text-teal-600 hover:underline">Login</a>
      </p>
    </form>
  </div>
