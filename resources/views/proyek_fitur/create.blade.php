...
<head>
    ...
    <title>Tambah Proyek Fitur</title>
...
<div class="max-w-xl mx-auto p-6 bg-white shadow-md rounded">
    ...
    <form action="{{ route('proyek-fitur.store') }}" method="POST" class="space-y-4">
        @csrf

        <div>
            <label class="block font-semibold">Nama Fitur</label>
            <input type="text" name="nama_fitur" class="w-full border p-2 rounded" required>
        </div>
